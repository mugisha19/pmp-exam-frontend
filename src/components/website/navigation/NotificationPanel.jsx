...
export const NotificationPanel = ({ onClose }) => {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed top-0 right-0 bottom-0 z-50 w-full sm:w-[320px] bg-white shadow-2xl">
        <div className="flex flex-col h-full">
          {/* Header */}
          <div className="px-3 py-2.5 bg-gradient-to-r from-[#476072] to-[#5a7a8f] text-white">
            ...
            <div className="flex gap-1">
              <button
                ...
                className="flex items-center gap-0.5 px-1.5 py-0.5 text-[9px] font-medium bg-white/10 hover:bg-white/20 rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <button
                ...
                className="flex items-center gap-0.5 px-1.5 py-0.5 text-[9px] font-medium bg-white/10 hover:bg-white/20 rounded transition-colors"
              >
                    ...
                    <div className="flex gap-1.5">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-1 mb-0.5">
                          <h4
                            className={cn(
                              "font-semibold line-clamp-1 text-[10px]",
                          ...
                          {!notification.is_read && (
                            <div className="w-1 h-1 bg-[#476072] rounded-full flex-shrink-0 mt-0.5" />
                          )}
                        </div>
                        <p className="text-[9px] text-gray-600 line-clamp-2 mb-0.5">

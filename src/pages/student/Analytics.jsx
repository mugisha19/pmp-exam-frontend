...
export const Analytics = () => {
  ...
  const { data: performanceData, isLoading: performanceLoading } = useQuery({
    ...
    queryFn: () => analyticsService.getStudentPerformance(user?.user_id, timeRange),
  ...
  const { data: quizStatsData, isLoading: quizStatsLoading } = useQuery({
    ...
    queryFn: () => analyticsService.getStudentQuizSpecific(user?.user_id, timeRange),
    enabled: !!user?.user_id,
  });
  ...
  const isLoading = performanceLoading || topicLoading || quizStatsLoading || activityLoading;

  // Process chart data
  const scoresTrendData = useMemo(() => {
    if (!quizStatsData?.quiz_stats) return [];
    return quizStatsData.quiz_stats
      .slice(0, 10)
      .map(quiz => ({
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <span>{performanceData?.attempts?.length || 0} quiz sessions</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <span>{Math.round(performanceData?.pass_rate || 0)}% pass rate</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                <div className="text-3xl font-bold text-gray-900">
                  {Math.round((performanceData?.attempts?.reduce((sum, a) => sum + (a.time_spent_minutes || 0), 0) || 0) / 60)}h
                </div>
            ...
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <span>{Math.round((performanceData?.attempts?.reduce((sum, a) => sum + (a.time_spent_minutes || 0), 0) || 0) % 60)}m total</span>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-600">
              ...
              <span>{performanceData?.attempts?.reduce((sum, a) => sum + (a.correct_answers || 0), 0) || 0} correct answers</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-xl font-bold text-gray-900">Quiz Performance Trend</h2>
                <p className="text-sm text-gray-500 mt-1">Your scores across recent quizzes</p>
              </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-xl font-bold text-gray-900">Pass/Fail Distribution</h2>
                <p className="text-sm text-gray-500 mt-1">Your overall performance breakdown</p>
              </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Your mastery level across different topics</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            ...
            <div className="space-y-3">
              {strongestTopics.length > 0 ? strongestTopics.map((topic, index) => (
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            ...
            <div className="space-y-3">
              {weakestTopics.length > 0 ? weakestTopics.map((topic, index) => (
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">How you compare to your peers</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-purple-50 rounded-lg text-center">
                ...
                <div className="text-xs text-gray-500 mt-1">
                  Top {100 - Math.round(groupComparisonData.percentile || 0)}% of class
                </div>
              </div>
              <div className="p-4 bg-emerald-50 rounded-lg text-center">
                <div className="text-sm text-gray-600 mb-1">vs. Group Average</div>
                <div className="text-3xl font-bold text-emerald-600">
                  {groupComparisonData?.user_average > groupComparisonData?.group_average
                    ? "+"
                    : ""}
                  {Math.round(
                ...
                <div className="text-xs text-gray-500 mt-1">
                  Group avg: {Math.round(groupComparisonData?.group_average || 0)}%
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="space-y-3">
            {recentActivityData?.last_7_days?.attempts && recentActivityData.last_7_days.attempts.length > 0 ? (
              recentActivityData.last_7_days.attempts.slice(0, 5).map((attempt, index) => (
                <div
                  key={index}
